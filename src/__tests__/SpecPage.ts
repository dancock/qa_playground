...
export class SpecPage {
  ...
  //I had some other code in here, but I kept failing because of timeout issues, 
  //so I eventually just copied over the code from the solution.
  //My code was similar to this, so I just decided to leave it.
  async navigate() {
